...
dibujarLinea('red', xCanvasStart - 1, yCanvasStart - 1, xCanvasStart + 1,
 yCanvasStart + 1, paper); // Dibujar punto en el centro
function drawWithArrowKeys(ourEvent) {
  ...
  if (ourEvent.keyCode in arrowKeys) {
    ...
    switch (arrowKeys[ourEvent.keyCode]) {
      ...
      break;
      case arrowKeys[39]:
        dibujarLinea('black', lineWidth, currentX, currentY, currentX + drawMovement, currentY,
         paper);
